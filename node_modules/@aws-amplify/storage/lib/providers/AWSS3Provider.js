...
var AWSS3UploadTask_1 = require("./AWSS3UploadTask");
 ...
 */
var AWSS3Provider = exports.AWSS3Provider = /** @class */ (function () {
    /**
    ...
    function AWSS3Provider(config) {
        ...
        core_1.Hub.listen('auth', function (data) {
            var payload = data.payload;
            if (payload.event === 'signOut' || payload.event === 'signIn') {
                _this._storage.removeItem(StorageConstants_1.UPLOADS_STORAGE_KEY);
            }
        });
    ...
    AWSS3Provider.prototype.startResumableUpload = function (addTaskInput, config) {
        ...
        if (!(file instanceof Blob)) {
            throw new Error(StorageErrorStrings_1.StorageErrorStrings.INVALID_BLOB);
        }
        emitter.on(AWSS3UploadTask_1.TaskEvents.UPLOAD_PROGRESS, function (event) {
            if (progressCallback) {
        ...
        emitter.on(AWSS3UploadTask_1.TaskEvents.UPLOAD_COMPLETE, function (event) {
            if (completeCallback) {
        ...
        emitter.on(AWSS3UploadTask_1.TaskEvents.ERROR, function (err) {
            if (errorCallback) {
        ...
        var prefixPromise = core_1.Credentials.get().then(function (credentials) {
            var cred = core_1.Credentials.shear(credentials);
            return (0, S3ClientUtils_1.getPrefix)(__assign(__assign({}, config), { level: addTaskInput.accessLevel, credentials: cred }));
        });
        var task = new AWSS3UploadTask_1.AWSS3UploadTask({
            s3Config: s3Config,
            file: file,
            emitter: emitter,
        ...
        (0, StorageUtils_1.dispatchStorageEvent)(track, 'upload', { method: 'put', result: 'success' }, null, "Upload Task created successfully for ".concat(key));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, (0, S3_1.copyObject)((0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { storageAction: core_1.StorageAction.Copy })), params)];
                    case 3:
                        _c.sent();
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'copy', {
                            method: 'copy',
                            result: 'success',
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { emitter: emitter, storageAction: core_1.StorageAction.Get }));
                    ...
                    case 2:
                        ...
                        if (progressCallback) {
                            if (typeof progressCallback === 'function') {
                                emitter.on(utils_1.SEND_DOWNLOAD_PROGRESS_EVENT, function (progress) {
                        ...
                        return [4 /*yield*/, (0, S3_1.getObject)(s3Config, params)];
                    case 3:
                        response = _f.sent();
                        emitter.removeAllListeners(utils_1.SEND_DOWNLOAD_PROGRESS_EVENT);
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'download', { method: 'get', result: 'success' }, {
                            fileSize: Number(response.Body['size'] || response.Body['length']),
                        }, "Download success for ".concat(key));
                        return [2 /*return*/, response];
                    case 4:
                        error_2 = _f.sent();
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'download', {
                            method: 'get',
                            result: 'failed',
                    ...
                    case 6:
                        _f.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, (0, S3_1.headObject)(s3Config, params)];
                    case 7:
                        _f.sent();
                        return [3 /*break*/, 9];
                    case 8:
                        ...
                        if (((_a = error_3.$metadata) === null || _a === void 0 ? void 0 : _a.httpStatusCode) === 404) {
                            (0, StorageUtils_1.dispatchStorageEvent)(track, 'getSignedUrl', {
                                method: 'get',
                                result: 'failed',
                    ...
                    case 9:
                        ...
                        _b = S3_1.getPresignedGetObjectUrl;
                        _c = [__assign({}, s3Config)];
                        _e = { expiration: expires || DEFAULT_PRESIGN_EXPIRATION };
                        return [4 /*yield*/, s3Config.credentials()];
                    case 10: return [4 /*yield*/, _b.apply(void 0, [__assign.apply(void 0, _c.concat([(_e.credentials = _f.sent(), _e.signingRegion = s3Config.region, _e.signingService = S3_1.SERVICE_NAME, _e)])), params])];
                    case 11:
                        url = _f.sent();
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'getSignedUrl', { method: 'get', result: 'success' }, null, "Signed URL: ".concat(url));
                        return [2 /*return*/, url];
                    case 12:
                        error_4 = _f.sent();
                        logger.warn('get signed url error', error_4);
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'getSignedUrl', { method: 'get', result: 'failed' }, null, "Could not get a signed URL for ".concat(key));
                        throw error_4;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { storageAction: core_1.StorageAction.GetProperties }));
                        params = {
                            Bucket: bucket,
                            Key: final_key,
                        };
                    ...
                    case 3:
                        ...
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'getProperties', { method: 'getProperties', result: 'success' }, null, "getProperties successful for ".concat(key));
                        return [2 /*return*/, getPropertiesResponse];
                    case 4:
                        error_5 = _c.sent();
                        if (((_a = error_5.$metadata) === null || _a === void 0 ? void 0 : _a.httpStatusCode) === 404) {
                            (0, StorageUtils_1.dispatchStorageEvent)(track, 'getProperties', {
    ...
    AWSS3Provider.prototype.put = function (key, object, config) {
        ...
        var uploader = new AWSS3ProviderManagedUpload_1.AWSS3ProviderManagedUpload(params, opt, emitter);
        if (acl) {
            params.ACL = acl;
        }
        if (resumable === true) {
            var s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { storageAction: core_1.StorageAction.Put }));
            var addTaskInput = {
                bucket: bucket,
                key: key,
                s3Config: s3Config,
        ...
        try {
            if (progressCallback) {
                if (typeof progressCallback === 'function') {
                    emitter.on(utils_1.SEND_UPLOAD_PROGRESS_EVENT, function (progress) {
                        progressCallback(progress);
                    });
                }
                else {
            ...
            return uploader.upload().then(function (response) {
                ...
                (0, StorageUtils_1.dispatchStorageEvent)(track, 'upload', { method: 'put', result: 'success' }, null, "Upload success for ".concat(key));
                return { key: key };
            });
        }
        catch (error) {
            logger.warn('error uploading', error);
            (0, StorageUtils_1.dispatchStorageEvent)(track, 'upload', { method: 'put', result: 'failed' }, null, "Error uploading ".concat(key));
            throw error;
        }
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { storageAction: core_1.StorageAction.Remove }));
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, (0, S3_1.deleteObject)(s3Config, params)];
                    case 3:
                        response = _a.sent();
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'delete', { method: 'remove', result: 'success' }, null, "Deleted ".concat(key, " successfully"));
                        return [2 /*return*/, response];
                    case 4:
                        error_6 = _a.sent();
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'delete', { method: 'remove', result: 'failed' }, null, "Deletion of ".concat(key, " failed with ").concat(error_6));
                        throw error_6;
                    case 5: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, S3_1.listObjectsV2)((0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { storageAction: core_1.StorageAction.List })), __assign({}, params))];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        ...
                        _c.label = 9;
                    case 9:
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'list', { method: 'list', result: 'success' }, null, "".concat(list.results.length, " items returned from list operation"));
                        logger.debug('list', list);
                        return [2 /*return*/, list];
                    case 10:
                        error_7 = _c.sent();
                        logger.error('list InvalidArgument', error_7);
                        (0, StorageUtils_1.dispatchStorageEvent)(track, 'list', { method: 'list', result: 'failed' }, null, "Listing items failed: ".concat(error_7.message));
                        throw error_7;
